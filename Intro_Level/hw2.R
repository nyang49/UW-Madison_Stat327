...
a = scan("WI_donations.txt")
b = scan("NY_donations.txt")
...
WI.pos = a[a>0]
NY.pos = b[b>0]
WI.ord = order(WI.pos,decreasing = TRUE)
NY.ord = order(NY.pos,decreasing = TRUE)

WI.largest= WI.pos[WI.ord[1]]
WI.second.largest= WI.pos[WI.ord[2]]
NY.largest= NY.pos[NY.ord[1]]
NY.second.largest= NY.pos[NY.ord[2]]
